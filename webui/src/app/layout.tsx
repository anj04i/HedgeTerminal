...
export const metadata: Metadata = {
  title: 'HedgeTerminal',
  description:
    'HedgeTerminal is a professional-grade research interface for decoding capital flows and fund positioning.',
  icons: {
    icon: [
      { url: '/favicon.ico' },
  ...
  openGraph: {
    ...
    description:
      'Built for serious capital. A next-gen terminal for fund behavior, filings, and quarterly data.',
    type: 'website',
